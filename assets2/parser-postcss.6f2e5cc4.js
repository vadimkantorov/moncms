import { an as getDefaultExportFromCjs, ao as commonjsGlobal } from "./main.29906b64.js";
...
(function(module, exports) {
  (function(e) {
    ...
    var pe = U((wp, Gt) => {
      ...
      Gt.exports = er(typeof globalThis == "object" && globalThis) || er(typeof window == "object" && window) || er(typeof self == "object" && self) || er(typeof commonjsGlobal == "object" && commonjsGlobal) || function() {
        return this;
          ...
          for (; S < Y; ) {
            switch (q = M.charCodeAt(S), q === y && (G = S, E += 1), q) {
              ...
              case p:
                F = q === l ? "'" : '"', T = S;
                do
                  for (ne = false, T = M.indexOf(F, T + 1), T === -1 && ce("quote"), oe = T; M.charCodeAt(oe - 1) === m; )
                    oe -= 1, ne = !ne;
                while (ne);
...
var parserPostcss = /* @__PURE__ */ getDefaultExportFromCjs(parserPostcss$2.exports);
var parserPostcss$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  "default": parserPostcss
}, [parserPostcss$2.exports]);
export { parserPostcss$1 as p };
